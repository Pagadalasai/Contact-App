...
import net.javagudies.constants.AppConstants;
import net.javagudies.entity.Contact;
import net.javagudies.props.AppProperties;
import net.javagudies.service.ContactService;
